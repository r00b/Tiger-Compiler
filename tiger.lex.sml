...
fun yyAction42 (strm, lastMatch : yymatch) = (yystrm := strm;
      (cc := 0; YYBEGIN COMMENT; cc := !cc + 1; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction55(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction55(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction14(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction14(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ58(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction55(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ57(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction55(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction55(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction12(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction12(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction16(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction16(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction6(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction6(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction9(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction9(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction10(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction10(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction8(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction8(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction13(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction13(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction15(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction15(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction11(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction11(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction5(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction55(strm, yyNO_MATCH)
                  else yyQ94(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ101(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
       ...
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ105(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"!"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ13(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp = #" "
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ9(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ0 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"+"
              then yyQ3(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"+"
              then if inp = #"*"
                  then yyQ4(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                  else yyQ3(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"/"
              then yyQ5(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyQ3(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
      (* end case *))
in
  (case (!(yyss))
   of COMMENT => yyQ0(!(yystrm), yyNO_MATCH)
    | STRING_STATE => yyQ1(!(yystrm), yyNO_MATCH)
