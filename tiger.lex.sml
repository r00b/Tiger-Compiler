        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ48(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ48(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ53(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ48(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ86(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ48(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ90(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ48(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ48(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ48(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"!"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ5(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp = #" "
