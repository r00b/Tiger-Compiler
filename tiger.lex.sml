...
fun yyAction49 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (str := (!str) ^ controlCharCaps (yytext); continue())
      end
fun yyAction50 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (str := (!str) ^ controlCharLower (yytext); continue())
      end
fun yyAction51 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (str := (!str) ^ dddToASCII (yytext); continue())
      end
...
fun yyAction59 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal escape sequence: in string: " ^ yytext); continue())
      end
...
fun yyAction62 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal characters inside string: " ^ yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction64(strm, yyNO_MATCH)
                      else yyQ75(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction64(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ109(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
       ...
       of NONE => yyAction64(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ118(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
       ...
       of NONE => yyAction64(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ117(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
              else yyAction64(strm, yyNO_MATCH)
      (* end case *))
            ...
            if inp = #"["
              ...
              then if inp = #"+"
                  ...
                  then if inp = #"<"
                      ...
                      else yyQ55(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
                else if inp <= #"@"
                  then yyQ37(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
              ...
              then if inp = #"d"
                  ...
                  then if inp = #"f"
                      then yyQ64(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
                    else if inp = #"e"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"?"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ27(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #"a"
...
fun yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ29(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"2"
              then yyQ30(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"2"
              then yyAction59(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ30(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"!"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction59(strm, yyNO_MATCH)
                      else yyQ17(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                else if inp = #" "
...
fun yyQ13 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"9"
              then yyQ22(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"9"
              then if inp = #"\""
                  then yyQ18(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp < #"\""
                  then if inp = #"\v"
                      then yyQ15(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                    else if inp < #"\v"
                      then if inp = #"\t"
                  ...
                  then if inp = #"1"
                      then yyQ19(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                      else yyQ15(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp = #"3"
                  then yyQ20(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                  else yyQ21(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp = #"f"
              then yyQ16(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"]"
